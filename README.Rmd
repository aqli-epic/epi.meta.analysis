...
foo <- aqli_color %>%
  ...
  ggplot() +
  geom_col(mapping = aes(x = pm2021, y = count_pm2021_millions), fill = "cornflowerblue", alpha = 0.6, width = 0.7) +
  ggthemes::theme_hc() +
  scale_x_binned(limits = c(0, 140), breaks = seq(0, 140, 20)) +
...
foo1 <- epi %>%
  ...
  ggplot() +
  geom_col(mapping = aes(x = mean_pm2.5, y = count_mean_pm2.5), fill = "cornflowerblue", alpha = 0.6, width = 0.7) +
  ggthemes::theme_hc() +
  scale_x_binned(limits = c(0, 140), breaks = seq(0, 140, 20)) +
  labs(x = expression("Annual Average" ~ PM[2.5] ~ "(in µg/m³)"),
